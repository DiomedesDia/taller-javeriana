...
| Criterio | Puntos | Descripción | Estado |
|---|---|---|---|
| Config DataSources PostgreSQL + MySQL | 15% | Ambos funcionan correctamente | Implementado |
| Repositorios con Locks Pesimistas | 10% | Uso correcto de locks pesimistas | Implementado |
| Lógica Débito / Crédito | 15% | Validaciones y actualización saldos | Implementado |
| Patrón SAGA Orquestado | 30% | Flujo completo con compensación | Implementado |
| API REST | 10% | Endpoints responden correctamente | Implementado |
| Frontend Web | 10% | Interfaz funcional | Implementado |
| Docker Compose | 5% | Despliegue con un comando | Implementado |
| Manejo de Errores | 5% | Excepciones manejadas | Implementado |

---

## Reflexión Final

Este taller permitió confrontar uno de los desafíos más frecuentes en arquitecturas de software empresarial: mantener consistencia entre sistemas distribuidos con diferentes tecnologías de almacenamiento. La restricción de no poder usar transacciones XA/2PC entre PostgreSQL y MySQL no es una limitación artificial del enunciado, sino una realidad del mundo real que equipos de desarrollo enfrentan constantemente al integrar sistemas heterogéneos.
